...
- [LAN Skills](https://github.com/lan-accelerator/lan-skills) by [LAN Accelerator](https://github.com/lan-accelerator) - 27 AI skills for the venture capital ecosystem — startups, LPs, corporates, and fund operators. 4 suites covering pitch decks, deal memos, unit economics, term sheets, fund performance, portfolio construction, and more. Grounded in YC, Sequoia, a16z, ILPA, and LATAM benchmarks (LAVCA 2025, Cuantico 2026).
